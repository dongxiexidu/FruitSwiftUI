...
let fruitData: [Fruit] = [
    ...
    Fruit(
        title: "Strawberry",
        headline: "Widely appreciated for its characteristic aroma,  red color, juicy texture, and sweetness.ely appreciated for its characteristic aroma,  red color, juicy texture, and sweetnes",
        image: "strawberry",
